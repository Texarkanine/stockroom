...
Human user-guide / architecture / contributor prose lives under [`docs/`](../docs/) (properdocs site). Agents use `SKILL.md` + [`system-model.md`](../skills/sr-search/references/system-model.md) only — do not park a user-guide corpus under `skills/**/references/`. Recipe SSOT for gnarly `sr-query` starters lives under [`skills/sr-query/references/cookbook/`](../skills/sr-query/references/cookbook/); the generated warehouse ERD SSOT lives under [`skills/sr-query/references/warehouse-schema.md`](../skills/sr-query/references/warehouse-schema.md). Advanced docs keep a human-owned cookbook index and expose each recipe body via symlink under [`docs/advanced/cookbook/`](../docs/advanced/cookbook/), and expose the ERD via symlink at [`docs/advanced/warehouse-schema.md`](../docs/advanced/warehouse-schema.md), but agents still do not use the docs site as runtime input. Root `pyproject.toml` is a docs-toolchain stub; the engine remains under `skills/sr-search/`. Using-agent doctrines (`system-model.md`) and this maintainer briefing are related but not one SSOT — do not merge them. Contributor enter/verify/exit is [`docs/contributing/preparation.md`](../docs/contributing/preparation.md); day-to-day engine / Torch / docs / dashboard / skills loops and Make targets are [`docs/contributing/iteration/index.md`](../docs/contributing/iteration/index.md).
