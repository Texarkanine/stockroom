...
- **CI / release** — [`.github/workflows/ci.yaml`](../.github/workflows/ci.yaml), [`.github/workflows/docs.yaml`](../.github/workflows/docs.yaml), [`.github/workflows/pr-title.yaml`](../.github/workflows/pr-title.yaml) (conventional-commit PR titles), [`.github/workflows/release-please.yaml`](../.github/workflows/release-please.yaml). Dependency version updates: [`.github/dependabot.yaml`](../.github/dependabot.yaml) (UV docs + engine, GitHub Actions).
