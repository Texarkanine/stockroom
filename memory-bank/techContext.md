...
- **release-please** — [`release-please-config.json`](../release-please-config.json) + [`.release-please-manifest.json`](../.release-please-manifest.json); syncs version into both plugin manifests and `skills/sr-search/src/stockroom/__init__.py` (`x-release-please-version` marker on `__version__`).
