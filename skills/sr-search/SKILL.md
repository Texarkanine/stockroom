...
| Full skill-use or tool-use tables beyond dashboard top-N | `sr-query` alone — [cookbook](../sr-query/references/cookbook/index.md) (skills recipes are SQL escape hatches; extractors remain chart truth) |
