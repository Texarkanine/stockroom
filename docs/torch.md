...
- [`docs/development.md`](development.md) — torch-safe sync / `make torch`
- [`docs/using.md`](using.md) — local plugin install without `.venv`
- [`skills/sr-initialize/SKILL.md`](../skills/sr-initialize/SKILL.md) — guided onboard
