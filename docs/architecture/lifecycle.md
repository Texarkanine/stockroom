...
`sr-initialize` offers to install the job once. Manual catch-up remains available via CLI when results feel stale — see [User Guide → Load the Warehouse](../user-guide/ingest/index.md).
...
- Ingest, embed, and scheduling how-to: [User Guide → Load the Warehouse](../user-guide/ingest/index.md)
